...
if (!server.includes("CREATE TABLE IF NOT EXISTS ai_predictions(")) {
...
if (!server.includes('function aiMemoryBias(a){')) {
...
if (!server.includes("app.post('/api/ai-memory/snapshot'")) {
  ...
  server = server.replace("app.post('/api/ai-memory/snapshot',async", "app.post('/api/ai-memory/snapshot',optionalAuth,async");
  server = server.replace("app.get('/api/ai-memory/summary',async", "app.get('/api/ai-memory/summary',optionalAuth,async");
}
