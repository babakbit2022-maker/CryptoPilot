...
app.post('/api/ai/screenshot',auth,aiLimit,premium,async(req,res)=>{
  ...
  const language=(()=>{const x=String(req.body?.language||'fa').toLowerCase();return x==='en'||x==='ru'?x:'fa';})();
